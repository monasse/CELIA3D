...
const int Nx =100;                 //nombre de cellules de fluide selon x
const int Ny =50;                 //nombre de cellules de fluide selon y
const int Nz =50;                 //nombre de cellules de fluide selon z
