...
const int Nx =225;                 //nombre de cellules de fluide selon x
const int Ny =180;                 //nombre de cellules de fluide selon y
const int Nz =90;                 //nombre de cellules de fluide selon z
